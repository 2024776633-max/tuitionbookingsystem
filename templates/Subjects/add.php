...
<div class="row text-body-secondary">
    <div class="col-10">
        <h1 class="my-0 page_title"><?= __('Subject List') ?></h1>
                    ...
                    <div class="card-body text-secondary">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                ✅ Please ensure all required fields <strong>Subject Name</strong>, <strong>Level</strong>, and <strong>Status</strong> are filled in accurately.
                            </li>
                            <li class="list-group-item">
                                🔐 All submitted subject information will be securely stored and managed within the Tuition Booking System.
                            </li>
                            <li class="list-group-item">
                                🛠️ The system administrator reserves the right to review and update subject details when necessary to maintain data integrity.
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="col-md-8">
        <div class="card rounded-0 mb-3 bg-body-tertiary border-0 shadow">
            <div class="card-body text-body-secondary">
                ...
                <fieldset>
                    <legend class="fw-bold text-primary mb-4"><?= __('Add Subject') ?></legend>
