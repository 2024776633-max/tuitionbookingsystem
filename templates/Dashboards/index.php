...
<div class="row">
    ...
    <div class="activity-container">
        ...
        <div class="image-container img-one">
            <?= $this->Html->image('subjects.jpg', ['alt' => 'Sujects']); ?>
            <div class="overlay">
                <h3>
                    <?= $this->Html->link(
                        'Subjects',
                        ['controller' => 'Subjects', 'action' => 'index', 'prefix' => false],
                        ['class' => 'stretched-link header']
                    ) ?>
                </h3>
            </div>
        </div>
        ...
        <div class="image-container img-two">
            <?= $this->Html->image('tuition.webp', ['alt' => 'Tutors']); ?>
            <div class="overlay">
                <h3>
                    <?= $this->Html->link(
                        'Tutors',
                        ['prefix' => 'Admin', 'controller' => 'Tutors', 'action' => 'index'],
                        ['class' => 'stretched-link header']
                    ) ?>
                </h3>
            </div>
        ...
        <div class="image-container img-three">
            <?= $this->Html->image('logo.png', ['alt' => 'Tuition Booking']); ?>
            <div class="overlay">
                <h3>
                    <?= $this->Html->link(
                        'VBest Tuition',
                        ['controller' => 'Dashboard', 'action' => 'index', 'prefix' => false],
                        ['class' => 'stretched-link header']
                    ) ?>
                </h3>
            </div>
        ...
        <div class="image-container img-four">
            <?= $this->Html->image('bookings.jpg', ['alt' => 'Bookings']); ?>
            <div class="overlay">
                <h3>
                    <?= $this->Html->link(
                        'Bookings',
                        ['prefix' => 'Admin', 'controller' => 'Bookings', 'action' => 'index'],
                        ['class' => 'stretched-link header']
                    ) ?>
                </h3>
            </div>
        ...
        <div class="image-container img-five">
            <?= $this->Html->image('teams.png', ['alt' => 'Teams']); ?>
            <div class="overlay">
                <h3>
                    <?= $this->Html->link(
                        'Teams',
                        ['prefix' => 'Admin', 'controller' => 'Teams', 'action' => 'index'],
                        ['class' => 'stretched-link header']
                    ) ?>
                </h3>
            </div>
        ...
        <div class="image-container img-six">
            <?= $this->Html->image('students.jpg', ['alt' => 'Students']); ?>
            <div class="overlay">
                <h3>
                    <?= $this->Html->link(
                        'Students',
                        ['prefix' => 'Admin', 'controller' => 'Students', 'action' => 'index'],
                        ['class' => 'stretched-link header']
                    ) ?>
                </h3>
            </div>
...
<div class="row g-4">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card shadow-sm border-0 h-100 text-center p-3 hover-scale">
            <div class="icon mb-3 text-primary fs-2">
                📚
            </div>
            <h5 class="fw-bold">Tutor Profile Management</h5>
            <p class="text-muted small">
                Manage tutor profiles with subjects, skills, and availability for accurate bookings.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card shadow-sm border-0 h-100 text-center p-3 hover-scale">
            ...
            <h5 class="fw-bold">Real-Time Booking</h5>
            <p class="text-muted small">
                Instantly book tuition sessions with schedule management and conflict prevention.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card shadow-sm border-0 h-100 text-center p-3 hover-scale">
            <div class="icon mb-3 text-warning fs-2">
                ✅
            </div>
            <h5 class="fw-bold">Booking Status Tracking</h5>
            <p class="text-muted small">
                Track each booking from Pending to Approved and Completed with clarity.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card shadow-sm border-0 h-100 text-center p-3 hover-scale">
            ...
            <h5 class="fw-bold">Tutor Availability Control</h5>
            <p class="text-muted small">
                Manage tutor workloads effectively to avoid overbooking and conflicts.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card shadow-sm border-0 h-100 text-center p-3 hover-scale">
            <div class="icon mb-3 text-danger fs-2">
                📊
            </div>
            <h5 class="fw-bold">Administrative Reporting</h5>
            <p class="text-muted small">
                Generate reports to monitor bookings, tutor performance, and system usage.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card shadow-sm border-0 h-100 text-center p-3 hover-scale">
            <div class="icon mb-3 text-purple fs-2">
                💡
            </div>
            <h5 class="fw-bold">Seamless Communication</h5>
            <p class="text-muted small">
                Students, parents, and tutors can communicate efficiently within the platform.
            </p>
        </div>
    </div>
