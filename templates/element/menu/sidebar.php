...
<nav id="sidebar" class="bg-body-tertiary shadow">
    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <li class="menu-item">
                <?= $this->Html->link(__('<i class="fa-solid fa-users "></i> Teams'), ['controller' => 'Teams', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
            </li>
            <li class="menu-item">
                <?= $this->Html->link(__('<i class="fa-solid fa-calendar-check "></i> Bookings'), ['controller' => 'Bookings', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
            </li>
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Students' && $a_name == 'index' ? 'active' : '' ?>">
                     ...
                     <li class="menu-item <?= $c_name == 'Subjects' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-book "></i> Subjects'), ['prefix' => 'Admin', 'controller' => 'Subjects', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                     <li class="menu-item <?= $c_name == 'Tutors' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-chalkboard-user"></i> Tutors'), ['prefix' => 'Admin', 'controller' => 'Tutors', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                     <li class="menu-item <?= $c_name == 'Teams' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__(' <i class="fa-solid fa-users"></i> Teams'), ['prefix' => 'Admin', 'controller' => 'Teams', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                     <li class="menu-item <?= $c_name == 'Bookings' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__(' <i class="fa-solid fa-calendar-check"></i> Bookings'), ['prefix' => 'Admin', 'controller' => 'Bookings', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
